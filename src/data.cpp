...
ValueVariant Data_i1::getValue() const{return value;} 
...
ValueVariant Data_i8::getValue() const{return value;}
...
ValueVariant Data_i16::getValue() const{return value;}
...
ValueVariant Data_i32::getValue() const{return value;}
...
ValueVariant Data_i64::getValue() const{return value;}
void Data_i8::setValue(ValueVariant value){
...
ValueVariant Data_f32::getValue() const{return value;}
void Data_i8::setValue(ValueVariant value){
...
ValueVariant Data_f64::getValue() const{return value;}
void Data_i8::setValue(ValueVariant value){
...
ValueVariant Data_pointer::getValue() const {return value;}
